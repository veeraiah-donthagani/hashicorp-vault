  ...
  module Provider
    ...
    class VaultInstallationBinary < Chef::Provider
      ...
      def self.binary_checksum(node, resource)
        ...
        when 'linux-i386'
          case resource.version
          when '0.10.4' then '80f8668b81535316365a29783541123b66d7ef0fbfedcf315f274fb44ea96445'
        ...
        when 'linux-amd64'
          case resource.version
          when '0.10.4' then 'b3c8a62e8f2f1b2d9d7ddca3d8bda620ab0091bb038da0d013c26f7b6b18f13a'
